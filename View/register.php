...
<html>
    ...
    if(ptphone.length <=11 && empty(ptphone))
    {
            ...
            <form action="" method="POST" onsubmit="return collect_patient_data();">
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="ptfname" name="ptfname"></td>
                    </tr>

                    <tr>
                        <td><label for="Phone">Phone:</label></td>
                        <td><input type="text" id="ptphon" name="ptphon"></td>
                    </tr>

                    <tr>
                        <td><label for="Dob">Date of birth:</label></td>
                        <td><input type="date" id="ptdob" name="ptdob"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td> <input type="email" id="ptemail" name="ptemail"></td>
                    </tr>
