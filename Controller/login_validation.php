...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($uname === "admin" && $pass === "admin123") {
        ...
        // admin_validation.php (used by all admin pages) checks these keys
        ...
        // Check accounts created through Assign New Admin / Admin Register
        ...
        if (!$loggedIn) {
            // Check accounts created through Register (patients log in with their email)
